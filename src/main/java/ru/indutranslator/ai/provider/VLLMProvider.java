...
public class VLLMProvider implements AIProvider {
    ...
    public AIResponseDto generate(AIRequestDto request) {
        ...
        try {
            ...
            String baseUrl = System.getProperty("ai.vllm.base-url", "http://localhost:8000");
            ...
            log.error("vLLM generation failed: {}", e.getMessage(), e);
            throw new RuntimeException("vLLM generation failed: " + e.getMessage(), e);
        }
    }
