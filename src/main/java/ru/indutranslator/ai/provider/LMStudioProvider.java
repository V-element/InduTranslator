...
public class LMStudioProvider implements AIProvider {
    ...
    public AIResponseDto generate(AIRequestDto request) {
        ...
        try {
            ...
            String baseUrl = System.getProperty("ai.lmstudio.base-url", "http://localhost:1234");
            ...
            log.error("LM Studio generation failed: {}", e.getMessage(), e);
            throw new RuntimeException("LM Studio generation failed: " + e.getMessage(), e);
        }
    }
